...
final class XbotClient
{
    ...
    public function sendMusic(
        ...
        $musicXml = "<?xml version=\"1.0\"?><msg> <appmsg appid=\"{$appInfo['id']}\" sdkver=\"0\">  <title>{$cleanTitle}</title>  <des>{$cleanDescription}</des>  <type>3</type>  <url>https://v.qq.com/x/page/h3263ndozln.html</url>  <lowurl>https://v.qq.com/x/page/h3263ndozln.html</lowurl>  <dataurl>{$url}</dataurl>  <lowdataurl>{$url}</lowdataurl>  <songalbumurl>{$coverUrl}</cdnthumburl> <songlyric>{$lyrics}</songlyric>   <cdnthumbmd5></cdnthumbmd5>   <cdnthumblength>9867</cdnthumblength>   <cdnthumbwidth>121</cdnthumbwidth>   <cdnthumbheight>121</cdnthumbheight>   <cdnthumbaeskey></cdnthumbaeskey>   <aeskey></aeskey>   <encryver>0</encryver>   <filekey></filekey>  </appattach>  <md5></md5>  <musicShareItem>   <mvSingerName>旷野吗哪-20260104</mvSingerName>  </musicShareItem>  <tingListenItem>   <listenId>943062212259752420</listenId>   <type>1</type>   <listenItem></listenItem>  </tingListenItem> </appmsg> <fromusername>{$this->botWxid}</fromusername> <scene>0</scene> <appinfo>  <version>132</version>  <appname>{$appInfo['name']}</appname> </appinfo> <commenturl /></msg>";
